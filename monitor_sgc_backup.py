...
def calcular_distancia_km(lat, lon):
    ...
    # Evita errores numéricos en asin()
    a = max(
        0.0,
        min(1.0, a)
    )
...
def prueba_deduplicacion():
    ...
    print("1. Guardando evento por primera vez...")
    ...
    print()
    print("2. Intentando guardar nuevamente el mismo evento...")
